...
| Catalog | Starter **149**/1490 · Studio **249**/2490 · Scale **750**/7500 · US pitched at **$49/mo** (Stan, 09-17; was $60). **Email offer since 09-15 (Stan): 249 zł/mies. only, site built free, first month free, no contract; benefits list; no Google-rating clause; hook first; contact 571 088 012 or reply** — `outreach/email-1-template.md` v3 |
