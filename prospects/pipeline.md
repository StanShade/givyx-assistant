...
|---|---|---|---|---|---|---|
| 01 | **DP Detailing Kraków** | Kraków, Dębniki | **692 438 344** (mobile) | `fs-20260922-01` | dpdetailing.givyx.com (`l_bd5119c` / `a_c74e36a`) | **CALLED 2026-09-23 — clear NO** (Stan: „jednoznaczne nie”). Site stays up, noindex. Same day Stan sent one SMS (`fs-sms-0923`): „rozumiem, że nie potrzebują Państwo strony… prosta strona z formularzem, dlatego za darmo i gotowa… czy się podoba, czy nie”. **Stan opened the SMS link himself 09-23 ~15:59Z**, so the first `fs-sms-0923` session is his and doesn't count. Free-site test: run 1 of 3 = 0 acceptances so far |
