...
Read this first, then `LOG.md` (chronological detail). Last updated: **2026-09-17**.
...
| **Personalised demo sites live** | **52** at `<slug>.givyx.com` — **batch 6 (gucio · motogazda · zumsc · superserwis · autoklinika · senasauto · tonysauto · performanceauto · precisionauto · eliteauto) published 09-17 on Stan's "ok publish"** · batch 5 (strzelecki · autojack · autoexpert · kwdiagnostics · autocel · jnjauto · tenauto · jacksonsauto · masauto) published 09-16 after Stan's "ok publish" (first promote call was classifier-blocked; passed on retry)** · batch 4 (turbozolw · pimserwis · gocars · mauto · carmobile · autoperfetto · sylwek · pablocar · dieselsoft · vagserwis) published 09-15; earlier **23** — 11 sent (napierala · autofirma · latusek · pietruszko · rsauto · troutman · adp · independenceauto · herlehys · holbrook · force) + **12 built + sent 09-14** (dieselchip · lpgexpert · markauto · wmw · poslowski · idzikowski · spauto · bulek · carexpert · bartex · garage66 · gamerc). All **noindex**, maps un-gated, forms → info@ + Stan's Gmail. Index: `givyx.claudeBrain/dealership/clones/index.md` |
